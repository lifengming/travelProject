		...
		<ul class="sidebar-menu">
			...
			<shiro:hasRole name="travelaudit">
				<li class="treeview  ${param.mi==3 ? 'active' : ''}">
                    <a href="${basePath}<%=INDEX_URL%>"><i class="fa fa-bitbucket-square"></i>
            ...
            <li class="treeview"><a href="#"> <i class="fa fa-at"></i>
                <span>考勤管理</span> <i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                    <li class="active"><a href="#"><i class="fa fa-tasks"></i> 合同工</a></li>
                    <li class="active"><a href="#"><i class="fa fa-tasks"></i> 劳务派遣</a></li>
                    <li class="active"><a href="#"><i class="fa fa-tasks"></i> 第三方</a></li>
                </ul>
            </li>

            <li class="treeview"><a href="#"> <i class="fa fa-money"></i>
                <span>绩效管理</span> <i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                    <li class="active"><a href="#"><i class="fa fa-tasks"></i> 合同工</a></li>
                    <li class="active"><a href="#"><i class="fa fa-tasks"></i> 劳务派遣</a></li>
                    <li class="active"><a href="#"><i class="fa fa-tasks"></i> 第三方</a></li>
            ...
            <li class="treeview"><a href="#"> <i class="fa fa-train"></i>
                <span>休假管理</span> <i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                    <li class="active"><a href="#"><i class="fa fa-tasks"></i> 合同工</a></li>
                    <li class="active"><a href="#"><i class="fa fa-tasks"></i> 劳务派遣</a></li>
                    <li class="active"><a href="#"><i class="fa fa-tasks"></i> 第三方</a></li>
